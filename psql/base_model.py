...
from lib.util.identifier import create_uuid
from lib.util.string import camel_to_snake_case
...
class BaseMixin:
    ...
    def create(cls, *args, **kwargs):
        ...
        try:
            ...
            print(f"Error creating entity {cls!r}:")
            print(e)
    ...
    def save(self):
        try:
            ...
            print(f"Error saving entity {self!r}:")
            print(e)
